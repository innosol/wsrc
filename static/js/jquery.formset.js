...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            numberTableRows = function() {
                $('.' + options.formCssClass).each(function(j){
                $(this).children(':first').text(j+1);
                //alert(j);
                });
            },
    ...
    $.fn.formset.defaults = {
        ...
        table_numbering: false,                // table_numbering
    };
})(jQuery);
