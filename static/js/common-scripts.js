...
// custom scrollbar
    ...
    $(".portlet-scroll-2").niceScroll({styler:"fb",cursorcolor:"#4A8BC2", cursorwidth: '5', cursorborderradius: '0px', autohidemode: false, cursorborder: '', cursorminheight: 500});
...
// widget tools
    jQuery('.widget.active .widget-body').ready(function(){
        var el = jQuery(".widget .widget-body");
        el.hide();
        jQuery('.widget .tools .icon-chevron-down').removeClass("icon-chevron-down").addClass("icon-chevron-up");
        if(jQuery(".widget.active").hasClass("active")){
            jQuery(".widget.active .widget-body").show();
            jQuery('.widget.active .tools .icon-chevron-up').removeClass("icon-chevron-up").addClass("icon-chevron-down");
        }
    });
    ...
    jQuery('tr').click(function () {
        var uu = jQuery(this).children().children();
        uu.show().siblings().hide();
    });    
    */
    jQuery('.widget .tools .icon-remove').click(function () {
        jQuery(this).parents(".widget").parent().remove();
